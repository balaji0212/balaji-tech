      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50 hover:border-teal-500/50 transition-all duration-300 hover:scale-[1.02] relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag, tagIndex) => (
                    <span
                      key={tagIndex}
                      className="bg-slate-700/50 backdrop-blur-sm text-gray-300 px-3 py-2 rounded-xl text-sm hover:bg-teal-500/20 hover:text-teal-300 hover:scale-105 transition-all duration-200 border border-slate-600/50 hover:border-teal-500/30"
                    >
                      {tag}
                    </span>
                  ))}
