    ...
    <section id="services" className="py-20 px-4 bg-slate-800/30 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 text-white px-8 py-4 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-teal-500/25 font-semibold"
          >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  ...
                  {service.features.map((feature, featureIndex) => (
                    <div
                      key={featureIndex}
                      className="flex items-center gap-3 text-sm text-gray-400 hover:text-teal-300 transition-colors duration-200"
                    >
